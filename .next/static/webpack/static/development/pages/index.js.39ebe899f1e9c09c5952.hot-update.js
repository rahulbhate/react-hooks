...
var App = function App() {
  ...
  function goToNextSlide() {
    var newIndex = [property.index + 1];
    setProperty(properties[newIndex]);
    console.log(properties, property, isLoading, property.index, properties.length);
  }
  ...
  console.log(!isLoading || property.index);
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    className: property.index === 0 ? 'active' : 'deactive',
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73
    },
...
//# sourceMappingURL=index.js.39ebe899f1e9c09c5952.hot-update.js.map